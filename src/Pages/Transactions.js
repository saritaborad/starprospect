    ...
    const [columns, setColumns] = useState([
        ...
        },
        {
            ...
            options: {
                ...
                sort: true,
                customBodyRender: (data, i) => {
                    return <span className={`user-status  ${(data = 0 ? "deactive" : data === 1 ? "active" : "update")}`}>update</span>;
                },
            },
        },
        {
                                ...
                                <div className="ms-auto custom-design-dropdwon">
                                    <Dropdown>
                                        ...
                                        <Dropdown.Menu>
                                            ...
                                            <Dropdown.Item>Athlete</Dropdown.Item>
                                            <Dropdown.Item>Business</Dropdown.Item>
                                            <Dropdown.Item>Parent</Dropdown.Item>
                                            <Dropdown.Item>Coach</Dropdown.Item>
                                            <Dropdown.Item>Fan</Dropdown.Item>
                                            <Dropdown.Item>Successfull</Dropdown.Item>
